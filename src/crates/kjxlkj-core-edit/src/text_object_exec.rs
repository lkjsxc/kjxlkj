...
use crate::text_object_delimited::{
    resolve_bracket, resolve_paragraph, resolve_quote, resolve_sentence,
};
...
pub fn resolve_text_object(
    ...
    match obj.kind {
        ...
        TextObjectKind::Tag => resolve_tag(obj.scope, cursor, content),
...
mod tests {
    ...
    fn word_inner() {
        ...
        let obj = TextObject::new(TextObjectScope::Inner, TextObjectKind::Word);
