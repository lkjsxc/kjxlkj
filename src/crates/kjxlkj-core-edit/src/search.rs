...
use crate::search_nav::{find_at_or_after, find_before};
use crate::search_types::{SearchDirection, SearchMatch};
...
mod tests {
    ...
    fn test_next_prev_match() {
        ...
        assert_eq!(state.next_match().unwrap().line, 0);
