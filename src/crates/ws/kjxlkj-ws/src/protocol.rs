//! WebSocket protocol message types per /docs/spec/api/websocket.md.

use serde::{Deserialize, Serialize};
use uuid::Uuid;

/// Client→Server messages per /docs/spec/api/websocket.md.
...
/// Server→Client messages per /docs/spec/api/websocket.md.
