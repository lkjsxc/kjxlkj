...
<div class="editor-url-card"><small>Preview</small><strong id="preview-state">Closed</strong></div>
</div>
<div class="editor-workspace">
<textarea id="editor-source" class="note-editor" spellcheck="false">{}</textarea>
<section id="editor-preview" class="surface editor-preview prose" hidden></section>
</div>
