...
Use this subtree for shared page chrome and resource workspace layouts.

## Read This Section When

- You need the root shell or rail rules.
- You need canonical rail action ordering.
- You need the resource workspace, dashboard, settings, or history page contract.
- You need to understand shared navigation and metadata across notes and media.
...
- [history-pages.md](history-pages.md): history index layout and access rules
