...
Use this subtree for user-visible canon: users, personal spaces, routes, APIs,
resource behavior, and UI contracts.

## Read This Section When

- You need to know what the app exposes.
- You need the personal-space URL and permission model.
...
- [surface/README.md](surface/README.md): personal-space routes, pages, file URLs, and write-auth surface
- [navigation/README.md](navigation/README.md): shared timeline and pager navigation canon
- [live/README.md](live/README.md): public live broadcast page and WebRTC signaling canon
...
- [api/README.md](api/README.md): JSON, multipart, settings, and machine-facing route contracts

## Start Here

- Resource model: [resources/resource-kinds.md](resources/resource-kinds.md)
- Route map: [surface/routes.md](surface/routes.md)
- Write auth: [surface/write-auth.md](surface/write-auth.md)
