...
Use this subtree for canonical `Prev` / `Next` rules shared across rails and pagers.
...
- [timeline/semantics-and-order.md](timeline/semantics-and-order.md)
- [paging/cursor-and-labels.md](paging/cursor-and-labels.md)
