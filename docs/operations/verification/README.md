...
Use this subtree for the canonical acceptance path and deeper manual verification runbooks.

## Read This Section When

- You need the exact compose pipeline used for acceptance.
- You need to understand what `verify` and `visual-verify` must do.
- You need the manual endpoint or browser checklist after boot.
