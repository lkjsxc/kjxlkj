...
Use this subtree for scripted command bundles and CI behavior.

## Read This Section When

- You need the exact command contract used by automation.
- You need CI workflow expectations.
- You need the failure-handling sequence after a broken automated run.
