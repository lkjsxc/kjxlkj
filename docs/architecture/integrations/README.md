...
Use this subtree for contracts that depend on external libraries, data formats, or compliance requirements.

## Read This Section When

- You need exact JSON shapes.
- You need password hashing and validation rules.
- You need time-format rules or dependency license inventory.
