...
| `LIM-GAP-TRACE-02` | [/docs/spec/architecture/input-decoding.md](/docs/spec/architecture/input-decoding.md) | 2026-02-11 | failure traces include layout/session summary, top-frame line, and bounded raw+normalized action history in `src/crates/app/kjxlkj/src/main.rs`; covered by `KEY-TRACE-05` in `src/crates/app/kjxlkj-test-harness/tests/key_mode_e2e.rs` |
