...
- Repository remains docs-only after preparation reset.
...
| `LIM-UI-02` | [/docs/spec/ui/README.md](/docs/spec/ui/README.md) | focused notes UI shell absent (including setup/login split, compact-screen toggle, title propagation, minimal editor chrome) | `M2 missing feature` | high | `E2E-03`, `E2E-06..08`, `E2E-11..14` | reconstruct frontend shell and editor UX contracts |
...
| `LIM-LIB-01` | [/docs/spec/technical/librarian-agent.md](/docs/spec/technical/librarian-agent.md) | autonomous librarian structuring runtime absent | `M2 missing feature` | high | `API-AUTO-03`, `API-AUTO-04`, `WS-06`, `E2E-15` | implement provider adapters, XML parser, and operation apply engine |
...
| `LIM-LIB-GUARD-01` | [/docs/spec/api/librarian-xml.md](/docs/spec/api/librarian-xml.md) | XML protocol parse/retry regressions are not yet guarded in runtime CI | `M4 verification gap` | high | add deterministic parser and fallback regression suite for small-model outputs |
