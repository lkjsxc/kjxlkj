...
- [ ] IMP-CSRF-01: CSRF token validation middleware
- [ ] IMP-SESSION-01: Session extraction middleware from cookie/header
...
- [ ] IMP-ATTACH-01: Attachment upload/download streaming endpoints
- [ ] IMP-EXPORT-01: Export and backup job endpoints
- [ ] IMP-RATE-01: Rate limiting middleware for auth endpoints
