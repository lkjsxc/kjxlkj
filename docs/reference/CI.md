...
- Active required profile: `Docs-integrity`.
- Runtime-oriented profiles are blocked until reconstruction resumes.
...
| `Core-runtime` | API/WS/runtime claims | `Typed-skeleton` + runtime integration checks |
