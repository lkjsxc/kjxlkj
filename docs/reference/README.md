...
The repository is in reconstructed-runtime mode.
...
- Runtime artifacts are present under `/src/crates/` with workspace manifests at
  repository root.
- Top-level and wave TODO checklists are fully checked with release gate marked
  satisfied.
