...
| `S05` | security closure | [/docs/todo/waves/stage-05-auth-and-security/README.md](/docs/todo/waves/stage-05-auth-and-security/README.md) | auth/session/csrf tests | `complete` |
