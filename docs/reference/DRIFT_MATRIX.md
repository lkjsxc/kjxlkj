...
|---|---|---|---|---|---|---|---|
| `R-BASELINE-01` | [/docs/spec/architecture/workspace-manifest.md](/docs/spec/architecture/workspace-manifest.md) | grouped workspace and crate tree exist | topology + build gate | verified | closed | implement | 20-crate workspace, `cargo check --workspace` passes, 91 tests pass (2026-02-11) |
...
| `R-OP-01` | [/docs/spec/editing/operators/README.md](/docs/spec/editing/operators/README.md) | operator grammar, g-prefix ops, double forms, case transforms | unit tests | partial | `M4` | test-add | 10-variant Operator enum, gu/gU/g~/gq/gJ/D/Y dispatch, RangeType/Inclusivity classification; T2 pending |
