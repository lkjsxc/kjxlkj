...
| `R-EXP-02` | [/docs/spec/features/navigation/file_explorer.md](/docs/spec/features/navigation/file_explorer.md) | explorer open-target actions and reliability hold under churn | `src/crates/app/kjxlkj/src/main.rs`, `src/crates/core/kjxlkj-core-state/src/editor_window.rs` | `EXP-03R`..`EXP-06R` | test-gap | `M2 missing feature` | implement + test-add | partial (`cargo test -p kjxlkj-test-harness --test explorer_terminal_paths_e2e --test explorer_terminal_more_e2e` covers `EXP-03R` and `EXP-04R`) |
| `R-TERM-01` | [/docs/spec/features/terminal/terminal.md](/docs/spec/features/terminal/terminal.md) | terminal launch and close-path lifecycle are stable | `src/crates/app/kjxlkj/src/main.rs`, `src/crates/core/kjxlkj-core-state/src/editor_window.rs` | `TERM-01R`..`TERM-05R` | test-gap | `M2 missing feature` | implement + test-add | partial (`cargo test -p kjxlkj-test-harness --test explorer_terminal_paths_e2e --test explorer_terminal_more_e2e` covers `TERM-01R`..`TERM-05R`) |
| `R-TERM-02` | [/docs/spec/features/terminal/terminal.md](/docs/spec/features/terminal/terminal.md) | terminal responsiveness and CJK churn stay stable | `src/crates/app/kjxlkj/src/main.rs`, `src/crates/core/kjxlkj-core-state/src/editor_window.rs` | `TERM-06R`, `TERM-07R`, `BD-RACE-01` | test-gap | `M2 missing feature` | implement + test-add | partial (`cargo test -p kjxlkj-test-harness --test explorer_terminal_more_e2e` covers `TERM-06R` and `TERM-07R`) |
| `R-WRAP-01` | [/docs/spec/features/ui/viewport.md](/docs/spec/features/ui/viewport.md) | long lines and wide graphemes wrap without overflow | `src/crates/platform/kjxlkj-render/src/grid.rs`, `src/crates/app/kjxlkj/src/main.rs` | `WRAP-11R`..`WRAP-16R` | test-gap | `M2 missing feature` | implement + test-add | partial (`cargo test -p kjxlkj-test-harness --test cursor_wrap_e2e` covers `WRAP-11R`..`WRAP-13R` baselines) |
| `R-CUR-02` | [/docs/spec/editing/cursor/README.md](/docs/spec/editing/cursor/README.md) | cursor remains visible and grapheme-safe in churn | `src/crates/core/kjxlkj-core-state/src/editor.rs`, `src/crates/platform/kjxlkj-render/src/grid.rs`, `src/crates/app/kjxlkj/src/main.rs` | `CUR-07R`..`CUR-11R` | test-gap | `M2 missing feature` | implement + test-add | partial (`cargo test -p kjxlkj-test-harness --test cursor_wrap_e2e` covers `CUR-07R`, `CUR-09R`, `CUR-11R` baselines) |
