...
|---|---|---|---|---|---|---|---|
| `R-BASELINE-01` | [/docs/spec/architecture/workspace-manifest.md](/docs/spec/architecture/workspace-manifest.md) | grouped workspace and crate tree exist | topology + build gate | verified | closed | implement | 20-crate workspace, `cargo check --workspace` passes, 132 tests pass (2026-02-11) |
...
| `R-REG-01` | [/docs/spec/editing/registers/README.md](/docs/spec/editing/registers/README.md) | register store with named/numbered/unnamed/small-delete/blackhole/clipboard | unit tests | partial | `M4` | test-add | RegisterStore with record_yank/record_delete, numbered rotation, A-Z append, blackhole "_ suppression, clipboard "+/"* stubs, put p/P; 8 unit tests; T2 pending |
