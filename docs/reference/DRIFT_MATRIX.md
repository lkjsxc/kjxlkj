...
| `R-RUNTIME-01` | [/docs/spec/architecture/runtime.md](/docs/spec/architecture/runtime.md) | runtime services are reconstructed and reachable | aligned — 10 crates, 134 tests, AppState DI | closed | maintain |
...
| `R-TEST-01` | [/docs/spec/technical/testing.md](/docs/spec/technical/testing.md) | acceptance pack is executable | aligned — 134 tests, T0+T1+property+snapshot, 18+ acceptance IDs | closed | add E2E |
