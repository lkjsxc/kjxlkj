...
| `R-RUNTIME-01` | [/docs/spec/architecture/runtime.md](/docs/spec/architecture/runtime.md) | runtime services are reconstructed and reachable | aligned — 10 crates, 71 tests, AppState DI | closed | maintain |
...
| `R-TEST-01` | [/docs/spec/technical/testing.md](/docs/spec/technical/testing.md) | acceptance pack is executable | aligned — 71 tests, T0+T1, 15 acceptance IDs | closed | add E2E |
| `R-CSRF-01` | [/docs/spec/security/csrf.md](/docs/spec/security/csrf.md) | CSRF token validation for mutations | partial — middleware stub | `M2` | implement |
| `R-SESSION-01` | [/docs/spec/security/sessions.md](/docs/spec/security/sessions.md) | cookie session extraction | partial — session builder exists | `M2` | implement middleware |
