...
|---|---|---|---|---|---|
| `R-RUNTIME-05` | [/docs/spec/architecture/runtime.md](/docs/spec/architecture/runtime.md) | runtime startup and supervision path exists and is verified | partial | `M2` | implement |
| `R-API-05` | [/docs/spec/api/http.md](/docs/spec/api/http.md) | API endpoints are reachable and verified | partial | `M2` | implement |
| `R-WS-05` | [/docs/spec/api/websocket.md](/docs/spec/api/websocket.md) | WebSocket protocol is reachable and verified | partial | `M2` | implement |
| `R-UI-06` | [/docs/spec/ui/web-app.md](/docs/spec/ui/web-app.md) | typed web app runtime is user-reachable | partial | `M2` | implement |
| `R-AUTO-04` | [/docs/spec/technical/librarian-agent.md](/docs/spec/technical/librarian-agent.md) | librarian automation rule/run/review contract is executable and verified | partial | `M2` | implement |
| `R-SEC-05` | [/docs/spec/security/README.md](/docs/spec/security/README.md) | auth/session/csrf/rbac enforcement is complete and matrix-verified | partial | `M2` | implement |
| `R-TYPE-03` | [/docs/spec/technical/type-safety.md](/docs/spec/technical/type-safety.md) | backend compile gate and frontend strict type gate pass | aligned | closed | keep synchronized |
| `R-DOCKER-05` | [/docs/spec/architecture/deployment.md](/docs/spec/architecture/deployment.md) | root Docker artifacts, compose config, and health/readiness smoke pass | aligned | closed | keep synchronized |
...
| `R-TODO-STATE-01` | [/docs/todo/README.md](/docs/todo/README.md) | TODO checkboxes accurately reflect current reconstruction progression | aligned | closed | keep synchronized |
