...
| `R-TERM-01` | [/docs/spec/features/terminal/terminal.md](/docs/spec/features/terminal/terminal.md) | terminal lifecycle and mixed-window behavior are stable | `src/crates/app/kjxlkj/src/main.rs`, `src/crates/core/kjxlkj-core-state/src/editor_window.rs` | `TERM-01R`..`TERM-07R` | test-gap | `M2 missing feature` | implement + test-add | partial (`cargo test -p kjxlkj-test-harness --test explorer_terminal_paths_e2e` covers `TERM-01R`..`TERM-03R`) |
