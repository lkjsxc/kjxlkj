# Wave 081: Review UX and Command Flows

## Objective

Specify review interactions and command-flow constraints.
...
2. Apply wave-specific documentation updates for `review ux and command flows`.
...
- `S08-W081-AC01`: objective-level requirements are fully represented.
- `S08-W081-AC02`: cross-links resolve to canonical documents.
- `S08-W081-AC03`: wave completion checklist is fully satisfied.
