# Wave 030: Shell and Auth Routing

## Objective

Specify setup/login/home routing behavior and optional module visibility logic.
...
2. Apply wave-specific documentation updates for `shell and auth routing`.
...
- `S03-W030-AC01`: objective-level requirements are fully represented.
- `S03-W030-AC02`: cross-links resolve to canonical documents.
- `S03-W030-AC03`: wave completion checklist is fully satisfied.
