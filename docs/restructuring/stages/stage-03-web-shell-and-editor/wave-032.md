# Wave 032: Responsive Interaction Rules

## Objective

Specify split-pane and compact-menu behavior under viewport transitions.
...
2. Apply wave-specific documentation updates for `responsive interaction rules`.
...
- `S03-W032-AC01`: objective-level requirements are fully represented.
- `S03-W032-AC02`: cross-links resolve to canonical documents.
- `S03-W032-AC03`: wave completion checklist is fully satisfied.
