# Wave 041: Automation State Machine

## Objective

Specify automation rule lifecycle and run-state transitions.
...
2. Apply wave-specific documentation updates for `automation state machine`.
...
- `S04-W041-AC01`: objective-level requirements are fully represented.
- `S04-W041-AC02`: cross-links resolve to canonical documents.
- `S04-W041-AC03`: wave completion checklist is fully satisfied.
