# Wave 061: Provider and Prompt Loading

## Objective

Specify provider adapter behavior and prompt-pack loading invariants.
...
2. Apply wave-specific documentation updates for `provider and prompt loading`.
...
- `S06-W061-AC01`: objective-level requirements are fully represented.
- `S06-W061-AC02`: cross-links resolve to canonical documents.
- `S06-W061-AC03`: wave completion checklist is fully satisfied.
