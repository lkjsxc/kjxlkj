# Wave 021: Replay and Patch Semantics

## Objective

Specify ordered event replay, idempotent patch application, and reconnect behavior.
...
2. Apply wave-specific documentation updates for `replay and patch semantics`.
...
- `S02-W021-AC01`: objective-level requirements are fully represented.
- `S02-W021-AC02`: cross-links resolve to canonical documents.
- `S02-W021-AC03`: wave completion checklist is fully satisfied.
