...
Document setup lock, login transitions, and session continuity invariants.
...
2. Apply wave-specific documentation updates for `auth and session baseline`.
...
- `S01-W011-AC01`: objective-level requirements are fully represented.
- `S01-W011-AC02`: cross-links resolve to canonical documents.
- `S01-W011-AC03`: wave completion checklist is fully satisfied.
