# Wave 071: Ack, Replay, and Cursor Behavior

## Objective

Specify replay windows, ack semantics, and stale-cursor outcomes.
...
2. Apply wave-specific documentation updates for `ack, replay, and cursor behavior`.
...
- `S07-W071-AC01`: objective-level requirements are fully represented.
- `S07-W071-AC02`: cross-links resolve to canonical documents.
- `S07-W071-AC03`: wave completion checklist is fully satisfied.
