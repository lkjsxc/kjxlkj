# Wave 070: Workspace and Automation Event Surface

## Objective

Specify required event types and ordering constraints.
...
2. Apply wave-specific documentation updates for `workspace and automation event surface`.
...
- `S07-W070-AC01`: objective-level requirements are fully represented.
- `S07-W070-AC02`: cross-links resolve to canonical documents.
- `S07-W070-AC03`: wave completion checklist is fully satisfied.
