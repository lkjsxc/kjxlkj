...
| <a id="fi-08-validation-is-explicit-and-repeatable"></a>FI-08 | Validation commands and expected outcomes are explicit and repeatable. | Validation checks (`T12`..`T14`) |
