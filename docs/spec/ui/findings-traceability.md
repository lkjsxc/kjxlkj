...
| `USR-005` | mobile usability | constrained screens MUST allow collapsing navigation to expand editor | `UX-LAYOUT-02`, `UX-LAYOUT-04`, `UX-A11Y-01` | [layout-and-interaction.md](layout-and-interaction.md), [reconstruction-ux-requirements.md](reconstruction-ux-requirements.md) | `REG-USR-005`, `E2E-12`, `E2E-19` |
