...
| `USR-005` | mobile usability | constrained screens MUST allow collapsing navigation to expand editor, with top-right toggle and close-on-select behavior | [layout-and-interaction.md](layout-and-interaction.md) | `REG-USR-005`, `E2E-12`, `E2E-23` |
