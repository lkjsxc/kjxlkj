...
Normative rules for note lifecycle, event sourcing, records, attachments, and search.
...
- API contracts: [/docs/spec/api/README.md](/docs/spec/api/README.md)
- Technical constraints: [/docs/spec/technical/README.md](/docs/spec/technical/README.md)
