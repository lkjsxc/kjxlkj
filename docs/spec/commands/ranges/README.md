...
| Document | Content |
|----------|---------|
| [ranges.md](ranges.md) | Range syntax overview |
| [range-specs.md](range-specs.md) | Range specification details |
| [address-patterns.md](address-patterns.md) | Address pattern syntax |
