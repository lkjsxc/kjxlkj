...
- [ ] Expression mappings per [/docs/spec/scripting/mappings/expr-mappings.md](/docs/spec/scripting/mappings/expr-mappings.md)
- [ ] Terminal mappings per [/docs/spec/scripting/mappings/terminal-mappings.md](/docs/spec/scripting/mappings/terminal-mappings.md)
- [ ] Plug mappings per [/docs/spec/scripting/mappings/plug-mappings.md](/docs/spec/scripting/mappings/plug-mappings.md)
- [ ] SID mappings per [/docs/spec/scripting/mappings/sid-mappings.md](/docs/spec/scripting/mappings/sid-mappings.md)
- [ ] Special keys per [/docs/spec/scripting/mappings/special-keys.md](/docs/spec/scripting/mappings/special-keys.md)
...
- [ ] Script files per [/docs/spec/scripting/script-files.md](/docs/spec/scripting/script-files.md)
- [ ] Command-line completion per [/docs/spec/scripting/cmdline-completion.md](/docs/spec/scripting/cmdline-completion.md)
