# Wave: Placeholder Scaffolding (Iteration 35)
...
- [x] Confirm the canonical spec set is under:
  - [/docs/spec/README.md](/docs/spec/README.md)
- [x] Confirm project policies and constraints are under:
  - [/docs/policy/README.md](/docs/policy/README.md)
- [x] Confirm current surface tracking exists and is treated as authoritative for "what is implemented now":
  - [/docs/reference/CONFORMANCE.md](/docs/reference/CONFORMANCE.md)
  - [/docs/reference/LIMITATIONS.md](/docs/reference/LIMITATIONS.md)

### B. Create placeholder plan structure for implementation work

- [x] Create child checklists under:
  - [/docs/todo/current/wave-implementation/README.md](/docs/todo/current/wave-implementation/README.md)
- [x] In each child checklist, include:
  - scope statement
...
- [x] Include explicit placeholders for:
