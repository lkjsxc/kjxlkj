...
- [ ] Define how key decoding handles non-US layouts (or record limitations). — done: `keyboard_layout.rs` with LayoutRemapper for QWERTY/Dvorak/Colemak/Workman, `parse_layout()`
- [ ] Add tests covering layout-dependent key decoding behavior. — done: 7 tests for remap, preserve_hjkl, custom remaps
