...
- [x] Ensure keybinding tables do not bind `Space` to navigation (verify against [/docs/spec/ux/keybindings/navigation.md](/docs/spec/ux/keybindings/navigation.md)). — done: `leader_keys.rs` (input) with LeaderConfig (key=' ', timeout=1000ms), LeaderRegistry, default_leader_bindings (17 bindings)
...
- [x] Add PTY E2E regressions for at least: — done: pty_regressions.rs leader_explorer_scenario, leader_terminal_scenario
