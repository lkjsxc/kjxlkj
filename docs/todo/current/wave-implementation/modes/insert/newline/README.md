...
- [x] Reproduce the failure in an interactive PTY-driven test.
...
- [x] Fix the root cause and add a regression test that fails on the prior behavior.
  - Added tests: `test_insert_ctrl_j_newline`, `test_insert_ctrl_m_newline`, `test_insert_rapid_newlines_200`.
- [x] Update conformance/limitations docs as needed:
  - [/docs/reference/CONFORMANCE_MODES_KEYS.md](/docs/reference/CONFORMANCE_MODES_KEYS.md)
