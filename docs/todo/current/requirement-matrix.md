...
| `R-CUR-01` | [/docs/spec/editing/cursor/README.md](/docs/spec/editing/cursor/README.md) | `i`, `a`, `A` semantics differ correctly at EOL | high | `CUR-01`..`CUR-06`, `CUR-07R` | `aligned` |
| `R-CUR-02` | [/docs/spec/features/ui/cursor-customization.md](/docs/spec/features/ui/cursor-customization.md) | cursor remains visible and never targets continuation cells | high | `CUR-08R`..`CUR-11R` | `aligned` |
| `R-WRAP-01` | [/docs/spec/features/ui/viewport.md](/docs/spec/features/ui/viewport.md) | wrap never overflows and wide graphemes remain atomic | high | `WRAP-11R`..`WRAP-16R` | `aligned` |
...
| `R-EXP-01` | [/docs/spec/features/navigation/file_explorer.md](/docs/spec/features/navigation/file_explorer.md) | `:Explorer` and leader routes are reachable | high | `EXP-01R`, `EXP-02R` | `aligned` |
| `R-EXP-02` | [/docs/spec/features/navigation/file_explorer.md](/docs/spec/features/navigation/file_explorer.md) | explorer navigation, split-open, and file actions are reliable | high | `EXP-03R`..`EXP-06R` | `aligned` |
| `R-TERM-01` | [/docs/spec/features/terminal/terminal.md](/docs/spec/features/terminal/terminal.md) | terminal launch and PTY lifecycle are stable | high | `TERM-01R`..`TERM-05R` | `aligned` |
| `R-TERM-02` | [/docs/spec/features/terminal/terminal.md](/docs/spec/features/terminal/terminal.md) | terminal and editing remain responsive under flood and churn | high | `TERM-06R`, `TERM-07R`, `BD-RACE-01` | `aligned` |
