...
Define a deeply structured, implementation-ordered plan for:

- Reading and reconciling the specs and policies
- Producing complete, non-contradictory documentation
- Defining a reliable terminal editor implementation that can be built from docs
