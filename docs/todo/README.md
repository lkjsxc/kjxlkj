...
- [ ] `S02` implement notes + hybrid search from [/docs/spec/domain/notes.md](/docs/spec/domain/notes.md) and [/docs/spec/domain/search.md](/docs/spec/domain/search.md)
- [ ] `S03` rebuild Obsidian-like editor and responsive layout from [/docs/spec/ui/editor-flow.md](/docs/spec/ui/editor-flow.md) and [/docs/spec/ui/layout-and-interaction.md](/docs/spec/ui/layout-and-interaction.md)
- [ ] `S04` implement `kjxlkj-agent` JSON prompt + KV memory + YOLO mode from [/docs/spec/technical/librarian-agent.md](/docs/spec/technical/librarian-agent.md) and [/docs/spec/technical/agent-prompt-json.md](/docs/spec/technical/agent-prompt-json.md)
- [ ] `S05` run security/performance/operations gates from [/docs/spec/security/README.md](/docs/spec/security/README.md) and [/docs/spec/technical/README.md](/docs/spec/technical/README.md)
- [ ] `S06` close drift/limitations and release gate from [/docs/reference/DRIFT_MATRIX.md](/docs/reference/DRIFT_MATRIX.md), [/docs/reference/LIMITATIONS.md](/docs/reference/LIMITATIONS.md), and [/docs/reference/RELEASE.md](/docs/reference/RELEASE.md)
