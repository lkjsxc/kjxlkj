...
- [ ] restructure-step S04-W041-01: implement automation rule CRUD semantics from [/docs/spec/domain/automation.md](/docs/spec/domain/automation.md) [doc-link](/docs/spec/domain/automation.md)
- [ ] restructure-step S04-W041-02: implement run state machine transitions from [/docs/spec/domain/automation.md](/docs/spec/domain/automation.md) [doc-link](/docs/spec/domain/automation.md)
- [ ] restructure-step S04-W041-03: enforce per-trigger idempotency and replay-safe run creation from [/docs/spec/domain/automation.md](/docs/spec/domain/automation.md) [doc-link](/docs/spec/domain/automation.md)
- [ ] restructure-step S04-W041-04: align HTTP payloads and errors with [/docs/spec/api/types.md](/docs/spec/api/types.md) and [/docs/spec/api/errors.md](/docs/spec/api/errors.md) [doc-link](/docs/spec/api/types.md)
- [ ] restructure-step S04-W041-05: emit deterministic automation events per [/docs/spec/domain/events.md](/docs/spec/domain/events.md) [doc-link](/docs/spec/domain/events.md)
