...
- [ ] Scope statement is understood: Canonical authority ingestion, constraint capture, and reconstruction boundary setup.
...
- [ ] continue: [/docs/todo/waves/stage-00-foundation-ingestion/wave-001.md](/docs/todo/waves/stage-00-foundation-ingestion/wave-001.md)
