...
- [ ] restructure-step S02-W021-01: implement note/workspace subscribe flows from [/docs/spec/api/websocket.md](/docs/spec/api/websocket.md) [doc-link](/docs/spec/api/websocket.md)
- [ ] restructure-step S02-W021-02: implement `apply_patch` semantics with version checks from [/docs/spec/ui/editor-flow.md](/docs/spec/ui/editor-flow.md) [doc-link](/docs/spec/ui/editor-flow.md)
- [ ] restructure-step S02-W021-03: enforce idempotency replay semantics from [/docs/spec/api/websocket.md](/docs/spec/api/websocket.md) [doc-link](/docs/spec/api/websocket.md)
- [ ] restructure-step S02-W021-04: enforce ack cursor replay and stale-cursor failures from [/docs/spec/api/websocket.md](/docs/spec/api/websocket.md) [doc-link](/docs/spec/api/websocket.md)
- [ ] restructure-step S02-W021-05: enforce deterministic conflict/error codes from [/docs/spec/api/errors.md](/docs/spec/api/errors.md) [doc-link](/docs/spec/api/errors.md)
