...
- [ ] restructure-step S05-W051-V01: run `REG-IMP-*` and `REG-USR-*` packs from [/docs/spec/technical/testing.md](/docs/spec/technical/testing.md) [doc-link](/docs/spec/technical/testing.md)
