...
Back: [/docs/todo/waves/stage-03-commands-and-ranges/README.md](/docs/todo/waves/stage-03-commands-and-ranges/README.md)

## Wave Identity

- [x] Wave ID: `W024`
- [x] Stage: `Stage 03: Commands and Ranges`
- [x] Focus: Scope Freeze and Input Mapping
- [x] Stage scope understood: Ex command system, command execution pipeline, ranges, and substitution safety.
...
- [x] continue: [/docs/todo/waves/stage-03-commands-and-ranges/wave-025.md](/docs/todo/waves/stage-03-commands-and-ranges/wave-025.md)
