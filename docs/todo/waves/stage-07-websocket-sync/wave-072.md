...
- [ ] `Result:` pass
- [ ] `Proof:` single-run and 5x repeated runs passed (`1 passed; 0 failed` each run); replay stream asserted commit-order chain `note_patched < automation_run_queued < automation_run_running < automation_run_succeeded`
