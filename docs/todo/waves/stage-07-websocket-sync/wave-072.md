...
- [ ] `Check:` `cargo test -p kjxlkj-server tests_ws tests_ws_replay -- --nocapture` and `for i in 1 2 3 4 5; do cargo test -p kjxlkj-server tests_ws -- --nocapture; done` -> [/docs/spec/api/websocket.md](/docs/spec/api/websocket.md)
