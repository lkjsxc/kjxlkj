...
- [ ] Scope statement is understood: Split lifecycle, explorer/terminal routing, and mixed-pane focus invariants.
...
- [ ] continue: [/docs/todo/waves/stage-04-window-explorer-terminal/wave-038.md](/docs/todo/waves/stage-04-window-explorer-terminal/wave-038.md)
