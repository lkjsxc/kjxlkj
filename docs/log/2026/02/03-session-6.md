...
| File | Lines | Changes |
|------|-------|---------|
| kjxlkj-core-types/src/event.rs | ~424 | Added 22 new actions/motions |
| kjxlkj-core-mode/src/handler.rs | ~1090 | Added key bindings |
| kjxlkj-core-state/src/editor.rs | ~4750 | Added handlers |
